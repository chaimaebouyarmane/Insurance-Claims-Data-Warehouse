...
public class test implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJET11_test = new byte[0];
		static byte[] commonByteArray_PROJET11_test = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET11_test) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET11_test.length) {
					if (length < 1024 && commonByteArray_PROJET11_test.length == 0) {
						commonByteArray_PROJET11_test = new byte[1024];
					} else {
						commonByteArray_PROJET11_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET11_test, 0, length);
				strReturn = new String(commonByteArray_PROJET11_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET11_test, 0, length);
				strReturn = new String(commonByteArray_PROJET11_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:CNnnl7KYJdZZxGsym/lq/PPrK4yqBc8h1Uwi5NBv");
...
// ###############################      
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:DBqRh8ihXxOapQU3ePXRsKKxPoEntsQviOdMFe/F");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("yeeeest");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("yeeeest");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "yeeeest") + "";
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
							+ "(CLAIM_ID NUMBER(38,0)  ,count FLOAT ,somme FLOAT )");
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream("projet11/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 100746 characters generated by Talend Open Studio for Data Integration on the
 * 5 janvier 2023 à 05:40:43 WEST
 ************************************************************************************************/